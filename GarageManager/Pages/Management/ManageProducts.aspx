<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManageProducts.aspx.cs" Inherits="Pages_Managerment_ManageProducts" %>
...
<p>
    Description:</p>
<p>
    <asp:TextBox ID="txtDescription" runat="server" Height="71px" TextMode="MultiLine" Width="204px"></asp:TextBox>
</p>
<p>
